...
const formValidationSchema: yup.SchemaOf<IFormData> = yup.object().shape({
  // nomeCompleto: yup.string().required('O campo é obrigatório').min(3, 'O campo precisa ter pelo menos 3 caracteres.'), // uma das formas de trazer mensagem customizada
...
export const DetalheDeCidades: React.FC = () => {
  ...
  const handleSave = (dados: IFormData) => {
    ...
    //   setIsLoading(false);
    //   return; // formato devalidação sem biblioteca
    // }
  };
